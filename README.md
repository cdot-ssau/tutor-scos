...
Панель СЦОС `https://studio.<платформа>/scos/`

Пользователи - возможно выбрать курс и просмотреть пользователей записанных на курс и имеющих связанную учетную запись СЦОС

Курсы - возможно выбрать курс для редактирования информации загруженной в СЦОС для имеющихся в СЦОС курсов или загрузить новый курс в СЦОС после подачи заявки на публикацию курса и получения его идентификатора.
